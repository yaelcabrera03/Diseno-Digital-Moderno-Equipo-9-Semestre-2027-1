...
def convertirbases(basem, basen, numero):
    ...
    if validacion:
        ...
        return numfinalentero, numfinalfraccion, validacion
...
while True:
    ...
    if op == 1:
        ...
        numfinalentero, numfinalfraccion, vali = convertirbases(basem, basen, numero)
        ...
        if validacion:
            ...
            numfinalentero1, numfinalfraccion1, vali1 = convertirbases(10, 2, str(numero1))
            numfinalentero2, numfinalfraccion2, vali2 = convertirbases(10, 2, str(numero2))
            ...
            if overflow:
                ...
                decimal_resultado, _ , val= convertirbases(2, 10, binariofinal[1:])  
